        ...
        <Content style={styles.background}>
            <Card style={styles.card}>
                ...
                <Body style={styles.body}>
                    <Text style={styles.bold}>Understanding Bipolar in a friend or family member</Text>
                    <View>
                        <Text style={styles.boldText}>Bipolar is a serious condition. </Text>
                        <Text style={styles.text} >Don’t underestimate the seriousness of Bipolar. Bipolar drains a person’s energy, optimism, and motivation. Your depressed loved one can’t just “snap out of it” by sheer force of will.</Text>
                        <Text style={styles.boldText}>Symptoms of Bipolar aren’t personal.</Text>
                        <Text style={styles.text} >Bipolar makes it difficult for a person to connect on a deep emotional level with anyone, even the people he or she loves most. In addition, depressed people often say hurtful things and lash out in anger. Remember that this is the Bipolar talking, not your loved one, so try not to take it personally.</Text>
                        ...
                        <Text style={styles.boldText}>You can’t “fix” someone else’s Bipolar.</Text>
                        <Text style={styles.text} >Don’t try to rescue your loved one from Bipolar. It’s not up to you to fix the problem, nor can you. You’re not to blame for your loved one’s Bipolar or responsible for their happiness (or lack thereof). Ultimately, recovery is in the hands of the depressed person.</Text>
                    </View>
                </Body>
                </CardItem>
            </Card>
            ...
            <Card>
                <CardItem>
                    <Text style={{color: 'blue'}}
                        onPress={() => Linking.openURL('https://www.helpguide.org/articles/Bipolar/helping-someone-with-Bipolar.htm')}>
                    More help
                    </Text>
                </CardItem>
            </Card>
